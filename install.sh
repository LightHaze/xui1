...
cd /root
wget "https://update.xui.one/XUI_1.5.13.zip" -O XUI_1.5.13.zip >/dev/null 2>&1
unzip XUI_1.5.13.zip >/dev/null 2>&1 # install xui 1.5.13 & unzip it in the root folder.
